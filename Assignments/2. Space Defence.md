# 2 Space Defence 1
Finish the Space defence game. This is the first part of a 3 part assignment that will need to be handed in once all parts are finished.
...
The grade for the assignment is equal to the total points
