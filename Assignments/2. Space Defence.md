...
Use the Game found [here]([https://github.com/Samonum/GameDevSamples/tree/main/3.%20Space%20Defence](https://github.com/Samonum/GameDevSamples/tree/main/Samples/3.%20Space%20Defence)) as the base. You may add extra methods, but do not change the signature (method name, parameters or return type) of the methods given in the template. Wherever applicable make proper use of GameTime.
