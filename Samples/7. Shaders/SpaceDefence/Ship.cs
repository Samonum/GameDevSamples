...
namespace SpaceDefence
{
    public class Ship : GameObject
    {
        ...
        public Ship(Point Position, Color teamColor)
        {
        ...
        public override void Draw(GameTime gameTime, SpriteBatch spriteBatch)
        {
            ...
            else
            {
                ...
                turretLocation.Location = _rectangleCollider.shape.Center;
                spriteBatch.Draw(laser_turret, turretLocation, null, teamColor, aimAngle, turretLocation.Size.ToVector2() / 2f, SpriteEffects.None, 0);
            }
